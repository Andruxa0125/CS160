...
cv::String face_cascade_name = "/Users/temp/projects/eyeLike/res/haarcascade_frontalface_alt.xml";
...
int main( int argc, const char** argv ) {
  cv::Mat frame;
  std::string videofilename = "/Users/temp/projects/eyeLike/data/sample1.mov"; 
...
std::string findEyes(cv::Mat frame_gray, cv::Rect face) {
  ...
  ss << "Right:(" << rightPupil.x << "," << rightPupil.y << ")";
  circle(faceROI, leftPupil, 3, 0);
  ss << "Left:(" << leftPupil.x << "," << leftPupil.y << ")";
